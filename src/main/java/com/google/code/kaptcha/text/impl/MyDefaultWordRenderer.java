...
/**
 * 重写{@link com.google.code.kaptcha.text.impl.DefaultWordRenderer}
 */
public class MyDefaultWordRenderer extends Configurable implements WordRenderer
{
	/**
	...
	public BufferedImage renderWord(String word, int width, int height)
	{
		...
		// recalculate startPosX
		//int startPosX = (width - widthNeeded) / 2;
		int startPosX = (width - widthNeeded) / wordChars.length;
		for (int i = 0; i < wordChars.length; i++)
		{
